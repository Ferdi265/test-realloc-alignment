...
extern "C" {
    #[allow(unused)] pub fn dlmalloc(size: size_t) -> *mut c_void;
    #[allow(unused)] pub fn dlrealloc(p: *mut c_void, size: size_t) -> *mut c_void;
    #[allow(unused)] pub fn dlrealloc_in_place(p: *mut c_void, size: size_t) -> *mut c_void;
    pub fn dlfree(p: *mut c_void);
    pub fn dlposix_memalign(p: *mut *mut c_void, alignment: size_t, size: size_t) -> c_int;
}
...
unsafe impl GlobalAlloc for DLMalloc {
    ...
    unsafe fn realloc(&self, ptr: *mut u8, _layout: Layout, new_size: usize) -> *mut u8 {
        unsafe { dlrealloc(ptr as *mut c_void, new_size) as *mut u8 }
    }
    ...
    unsafe fn realloc(&self, ptr: *mut u8, layout: Layout, new_size: usize) -> *mut u8 {
        ...
        // in-place.
        let mut new_ptr = unsafe { dlrealloc_in_place(ptr as *mut c_void, new_size) as *mut u8 };
